...
export class ClientTableComponent implements OnInit{
  ...
  deleteSelectedClients() {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.clientDataDelete.emit({type: 'multi', data: this.selectedClients?.map(client => client.id)});
  ...
  saveClient() {
    console.log('DEBUG: saving', this.currentClient);
    this.clientSave.emit({data: this.currentClient, type: this.isNewClient ? 'new' : 'edit'});
    this.closeDialog();
  }
