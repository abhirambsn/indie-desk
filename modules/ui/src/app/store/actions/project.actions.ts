...
export const loadProjectsSuccess = createAction('[PROJECT] Load Projects Success', props<{ payload: any }>());
...
export const saveProjectsuccess = createAction('[PROJECT] Save Project Success', props<{ payload: any }>());
...
export const deleteProjectsuccess = createAction('[PROJECT] Delete Project Success', props<{ payload: any }>());
