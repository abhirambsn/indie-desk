...
export const saveClient = createAction('[CLIENT] Save Client', props<{ payload: any }>());
...
export const updateClient = createAction('[CLIENT] Update Client', props<{ payload: any }>());

export const deleteClient = createAction('[CLIENT] Delete Client', props<{ payload: any }>());
