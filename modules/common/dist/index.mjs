...
var InvoiceModel = mongoose2.model("Invoice", invoiceSchema);

// src/models/project.model.ts
import mongoose3, { Schema as Schema3 } from "mongoose";
var projectSchema = new Schema3(
  {
    id: { type: String, required: true },
    name: { type: String, required: true },
...
var ProjectModel = mongoose3.model("Project", projectSchema);

// src/models/task.model.ts
import mongoose4, { Schema as Schema4 } from "mongoose";
var taskSchema = new Schema4(
  {
    id: { type: String, required: true },
...
var SupportTicketModel = mongoose5.model("SupportTicket", supportTicketSchema);

// src/models/ticket-comment.model.ts
import mongoose6, { Schema as Schema6 } from "mongoose";
var ticketCommentSchema = new Schema6({
  id: { type: String, required: true, unique: true },
  type: {
    type: String,
...
var TicketCommentModel = mongoose6.model("TicketComment", ticketCommentSchema);
export {
  ClientModel,
  InvoiceModel,
  ProjectModel,
